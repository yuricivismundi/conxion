...
export default function BlockDialog({
  ...
  return (
    <div className="fixed inset-0 z-[95] flex items-end justify-center bg-black/80 px-4 py-3 backdrop-blur-sm sm:items-center">
      <div className="flex max-h-[90dvh] w-full max-w-md flex-col overflow-hidden rounded-[28px] border border-white/10 bg-[#0c0e10] shadow-[0_0_0_1px_rgba(219,39,119,0.15),0_32px_80px_rgba(0,0,0,0.7),0_0_60px_rgba(219,39,119,0.08)]">
