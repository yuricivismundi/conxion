            ...
            {!sentState ? (
              <form onSubmit={submitAuth} className="space-y-6">
                ...
                <button
                  ...
                  disabled={googleLoading || loading || !!existingSession}
                  className="flex w-full items-center justify-center gap-3 rounded-xl border border-white/12 bg-white px-4 py-3 text-sm font-semibold text-[#1a1a1a] transition hover:bg-white/90 disabled:opacity-60"
                >
                  {googleLoading ? (
                    <span className="material-symbols-outlined animate-spin text-[18px] text-[#1a1a1a]">refresh</span>
                  ) : (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-semibold uppercase tracking-widest" style={{ color: BRAND.muted }}>or</span>
                  <div className="h-px flex-1 bg-white/10" />
                </div>
