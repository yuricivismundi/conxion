...
export const PROFILE_MEDIA_MAX_DIRECT_VIDEO_BYTES = 200 * 1024 * 1024;
...
export function countProfileMedia(
  ...
  return {
    ...
    canAddVideo:
      (limits.profileVideos === null || videos < limits.profileVideos) &&
      (totalLimit === null || effectiveTotalCount < totalLimit),
    canAddPhoto:
      (limits.profilePhotos === null || effectivePhotoCount < limits.profilePhotos) &&
      (totalLimit === null || effectiveTotalCount < totalLimit),
  };
}
